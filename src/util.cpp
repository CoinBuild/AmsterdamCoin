...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\AmsterdamCoin2
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\AmsterdamCoin2
    // Mac: ~/Library/Application Support/AmsterdamCoin2
    // Unix: ~/.amsterdamcoin2
#ifdef WIN32
    // Windows
    ...
    if (vTimeOffsets.size() >= 5 && vTimeOffsets.size() % 2 == 1)
    {
        ...
        else
        {
            ...
            if (!fDone)
            {
                ...
                {
                    fDone = true;
                    string strMessage = _("Warning: Please check that your computer's date and time are correct! If your clock is wrong AmsterdamCoin will not work properly.");
